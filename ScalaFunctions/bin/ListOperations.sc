object ListOperations {
  val lion=new listOfString(List("ab.has","avir.at","asah.ya","si.ya","av.ni"))
  val fruits="apples"::("banana"::("pears"::("litchy"::Nil)))
   val combo=lion ::fruits
     val sort=lion.isort(fruits)
     val sort2=lion.isortByPatternMatching(List("ab.has","avir.at","asah.ya","si.ya","av.ni"))
     val oper=new Someoperations()
     val flatten=oper.flatten
     val concat=oper.concat
}
...
val unfruits=fruits.filter(_.length<4)
